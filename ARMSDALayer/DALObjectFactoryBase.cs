...
namespace ARMSDALayer
{
    public abstract class DALObjectFactoryBase
    {
        ...
        //Parameter: An integer variable that contains either SQLSERVER =1, ORACLE =2
        // & MYSQL = 3.
        // The client of the DAL needs to call this method passing
        // one of the CONSTANT VARIABLES in this class:
        // DALObjectFactoryBase.SQLSERVER or
        // DALObjectFactoryBase.ORACLE, DALObjectFactoryBase.MYSQL
        //Return Value: Depending on the PARAMETER passed, it will return either a
        // SQLServerDAOFactory OBJECT that will perform the data access on
        // MSSQLServer or OracleDAOFactory OBJECT for Oracle data access, etc.
